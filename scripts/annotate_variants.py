...
ANNOTATION_FIELDS = [
    ...
    "gnomad_genome_faf95_popmax", "gnomad_genome_faf95_pop", "gnomad_genome_af_popmax",
    "gnomad_exome_af", "gnomad_exome_ac", "gnomad_exome_an", "gnomad_exome_hom",
    "gnomad_exome_faf95_popmax", "gnomad_exome_faf95_pop", "gnomad_exome_af_popmax",
...
def main():
    ...
    for k in order:
        ...
        unique_ann[k] = {
            ...
            "gnomad_genome_af_popmax": g.get("gnomad_genome_af_popmax"),
            ...
            "gnomad_exome_af_popmax": g.get("gnomad_exome_af_popmax"),
